...
export function Button({
  ...
  switch (size) {
    ...
    case "medium":
      sizeClass =
        "flex justify-center items-center px-[3.5rem] text-h4-bold py-2";
      break;
    case "large":
  ...
  switch (variant) {
    ...
    case "disabled":
      variantClass =
        "bg-secondary-700 text-neutral-100 cursor-not-allowed hover:opacity-90";
      break;
    default:
  ...
  return (
    <button
      className={`${sizeClass} ${variantClass} shadow-md ${className} cursor-pointer`}
      onClick={onClick}
